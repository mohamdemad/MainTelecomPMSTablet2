    ...
    public JSONArray makeHttpRequest(String url, String method, List<NameValuePair> params ,String check) {
        ...
        try {
            ...
            if(method == "POST"){
                ...
                System.out.println("POST    JSON PARAMS ::"+params.toString());
                ...
                is = httpEntity.getContent();
                Log.d("JSON PARAMS ::",params.toString());
                System.out.println("GET JSON PARAMS ::"+params.toString());
            }
        ...
        try {
            ...
            if(check== "EVALUATION"){ json1 = sb.toString();}
        ...
        try {
            if(check== "EVALUATION"){jObj1 = new JSONArray(json1);return jObj1;}
