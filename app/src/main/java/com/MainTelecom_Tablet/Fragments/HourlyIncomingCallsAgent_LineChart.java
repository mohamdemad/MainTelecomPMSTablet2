 ...
 */
public class HourlyIncomingCallsAgent_LineChart extends Fragment {

    LineChart Incoming_Agent_Calls_chart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View Incoming_Agent_Calls = inflater.inflate(R.layout.hourly_incoming_calls_agent_layout, container, false);

        Incoming_Agent_Calls_chart = (LineChart) Incoming_Agent_Calls.findViewById(R.id.hourly_incoming_calls_agent_chart);

        // Loading products in Background Thread
        new LoadAllData().execute();


        return Incoming_Agent_Calls;
    }
    ...
    private ArrayList<ILineDataSet> getDataSet() {
        ...
        LineDataSet lineDataSet2 = new LineDataSet(valueSet2, "Missed Calls");
       // lineDataSet2.setValueTextColor(Color.WHITE);
        ...
        LineDataSet lineDataSet3 = new LineDataSet(valueSet3, "Cancelled Calls");
            ...
            try {
                ...
                List<NameValuePair> params = new ArrayList<NameValuePair>();
                 ...
                 if(search_check==1) {
                     ...
                     JSONArray json1 = jParser.makeHttpRequest("http://"+ SaveSharedPreference.getUserIP(getActivity())+AppConfig.url_Hourly_Incoming_Calls_Agent, "POST", params, "ROLES");

                     Log.d("All Data:22 ", json1.toString());
                     System.out.println("H.I.A :"+json1.toString());
                     ...
                     JSONArray json2 = jParser2.makeHttpRequest("http://"+SaveSharedPreference.getUserIP(getActivity())+AppConfig.url_Hourly_Incoming_Calls_Agent,"POST",params,"ROLES");
                     Log.d("All Data:22 ",json2.toString());
                     System.out.println("H.I.A :"+json2.toString());
                     data_bar1.clear();
                     data_bar2.clear();
                     data_bar3.clear();
                     xAxis.clear();
...
//            l.setXEntrySpace(6f);
                ...
                Incoming_Agent_Calls_chart.setData(data);
          //      Incoming_Agent_Calls_chart.getXAxis().setTextColor(Color.WHITE);
            //    Incoming_Agent_Calls_chart.getLegend().setTextColor(Color.WHITE);
                Incoming_Agent_Calls_chart.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM);
                Incoming_Agent_Calls_chart.setDescription("");
                Incoming_Agent_Calls_chart.animateXY(2000, 2000);
                Incoming_Agent_Calls_chart.invalidate();

            }catch (Exception e){

//                AlertDialog.Builder alertDialog = new AlertDialog.Builder(getActivity());
//                alertDialog.setTitle("Error...");
//                alertDialog.setMessage("Check your Internet Connection "+e);
...
//                alertD.show();
    ...
    public HourlyIncomingCallsAgent_LineChart (){}
    public static HourlyIncomingCallsAgent_LineChart newInstance(String[] ids,String[] names){
        ...
        hourlyIncomingCallsAgentLineChart.setArguments(args);
