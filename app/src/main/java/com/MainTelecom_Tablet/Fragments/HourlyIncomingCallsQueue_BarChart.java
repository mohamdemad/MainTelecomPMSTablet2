 ...
 */
public class HourlyIncomingCallsQueue_BarChart extends Fragment{

    BarChart Hourly_Incoming_Queue_Calls_chart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View Hourly_Incoming_Queue_Calls = inflater.inflate(R.layout.hourly_incoming_calls_queue_barchart, container, false);

        Hourly_Incoming_Queue_Calls_chart = (BarChart) Hourly_Incoming_Queue_Calls.findViewById(R.id.hourly_incoming_calls_queue_chart);

        // Loading products in Background Thread
        new LoadAllData().execute();


        return Hourly_Incoming_Queue_Calls;
    }
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if(search_check==1) {
                    ...
                    JSONArray json1 = jParser.makeHttpRequest("http://"+ SaveSharedPreference.getUserIP(getActivity())+ AppConfig.url_Hourly_Incoming_Calls_Queue, "POST", params, "ROLES");

                    Log.d("All Data:22 ", json1.toString());
                    System.out.println("H.I.Q :"+json1.toString());
                    ...
                    JSONArray json_agents = jParser_agents.makeHttpRequest("http://"+ SaveSharedPreference.getUserIP(getActivity())+ AppConfig.url_Queues_Data_List,"GET",params_Agents,"ROLES");
                    Log.d("All Data:22 ",json_agents.toString());
                    System.out.println("Q.L :"+json_agents.toString());
                    params.clear();
                    ...
                    JSONArray json2 = jParser2.makeHttpRequest("http://"+ SaveSharedPreference.getUserIP(getActivity())+AppConfig.url_Hourly_Incoming_Calls_Queue,"POST",params,"ROLES");
                    Log.d("All Data:22 ",json2.toString());
                    data_bar1.clear();
                    data_bar2.clear();
                    data_bar3.clear();
                    data_bar4.clear();
...
//            l.setXEntrySpace(6f);
                ...
                Hourly_Incoming_Queue_Calls_chart.setData(data);
                Hourly_Incoming_Queue_Calls_chart.setDrawValueAboveBar(true);
          //      Hourly_Incoming_Queue_Calls_chart.getXAxis().setTextColor(Color.WHITE);
            //    Hourly_Incoming_Queue_Calls_chart.getLegend().setTextColor(Color.WHITE);
                Hourly_Incoming_Queue_Calls_chart.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM);
                Hourly_Incoming_Queue_Calls_chart.setDescription("");
                Hourly_Incoming_Queue_Calls_chart.animateXY(2000, 2000);
                Hourly_Incoming_Queue_Calls_chart.invalidate();
...
//                alertD.show();
    ...
    public HourlyIncomingCallsQueue_BarChart (){}
    public static HourlyIncomingCallsQueue_BarChart newInstance(String[] ids,String[] names){
        ...
        hourlyIncomingCallsQueueBarChart.setArguments(args);
