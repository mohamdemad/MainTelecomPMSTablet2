 ...
 */
public class IncomingAgentCalls_Barchart extends Fragment {
    BarChart Incoming_Agent_Calls_chart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View Incoming_Agent_Calls = inflater.inflate(R.layout.incoming_agent_calls_layout, container, false);

        Incoming_Agent_Calls_chart = (BarChart) Incoming_Agent_Calls.findViewById(R.id.incoming_agent_calls_chart);
    ...
    private ArrayList<String> getXAxisValues() {
        ...
        if (search_check==1){
            xAxis = new ArrayList<String>(Arrays.asList(xAxis_data));
        }else {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (search_check == 1) {
                    ...
                    JSONArray json1 = jParser.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Incoming_Calls_Agent, "POST", params, "ROLES");

                    Log.d("All Data: ", json1.toString());
                    System.out.println("Incoming call agent :"+json1.toString());
                    ...
                    JSONArray json2 = jParser2.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Incoming_Calls_Agent, "POST", params, "ROLES");
                    Log.d("All Data: ", json2.toString());
                    System.out.println("Incoming call agent :"+json2.toString());
                    data_bar1.clear();
                    data_bar2.clear();
                    data_bar3.clear();
                    ...
                    for (int i = 1; i <= max2; i++) {
                        ...
                        Agent_Name = ccc.getString("Agent_Name");
                        //abandoned_calls = c.getString("abandoned_calls");
                        data_bar1.add(Float.parseFloat(completed_calls));
                        data_bar2.add(Float.parseFloat(missed_calls));
                        data_bar3.add(Float.parseFloat(cancelled_calls));
...
//            l.setXEntrySpace(6f);
          ...
          //      Incoming_Agent_Calls_chart.getLegend().setTextColor(Color.WHITE);
            //    Incoming_Agent_Calls_chart.getXAxis().setTextColor(Color.WHITE);
                Incoming_Agent_Calls_chart.setDrawValueAboveBar(true);
...
//                alertDialog.setMessage("Check your Internet Connection " +e.getMessage());
...
//                alertD.show();
    ...
    public IncomingAgentCalls_Barchart(){}
    public static IncomingAgentCalls_Barchart newInstance(String[]ids,String[]names){
        ...
        incomingAgentCallsBarchart.setArguments(args);
