 ...
 */
public class DepartmentEffort_BarChart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View Dep_Effort = inflater.inflate(R.layout.department_effort_barchart, container, false);

        chart = (BarChart) Dep_Effort.findViewById(R.id.chart);

        // Loading products in Background Thread
        new LoadAllData().execute();
//        swipeContainer = (SwipeRefreshLayout) Dep_Effort.findViewById(R.id.swipeContainer);
    ...
    class LoadAllData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (search_check==1){
                    ...
                    JSONArray json_department = jParser_Department1.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_department_effort, "POST", params_department, "DEPARTMENT");
                    Log.d("All Data: ", json_department.toString());
                    ...
                    data_bar1.clear();
                    data_bar2.clear();
                    params_department.add(new BasicNameValuePair("FromDate", "2015-6-1"));
                    params_department.add(new BasicNameValuePair("ToDate", "2016-6-15"));
                    ...
                    JSONArray json_department = jParser_Department2.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_department_effort, "POST", params_department, "DEPARTMENT");
        ...
        protected void onPostExecute(String file_url) {
            ...
            l.setXEntrySpace(6f);*/
                ...
                data.setValueFormatter(new StackedValueFormatter(false, "||||", 00));
...
//                alertD.show();
    ...
    public DepartmentEffort_BarChart(){}
    public static DepartmentEffort_BarChart newInstance(String[]ids,String[]names){

        DepartmentEffort_BarChart departmentEffortBarChart = new DepartmentEffort_BarChart();
        final Bundle args = new Bundle(2);
        args.putStringArray("IDS",ids);
        args.putStringArray("NAMES",names);
        departmentEffortBarChart.setArguments(args);
        return departmentEffortBarChart;
