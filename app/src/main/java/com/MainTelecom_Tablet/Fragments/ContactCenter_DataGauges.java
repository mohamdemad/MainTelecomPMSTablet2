 ...
 */
public class ContactCenter_DataGauges extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View fragment_speedometer = inflater.inflate(R.layout.speedometer_layout, container, false);
        ...
        speedometer_target = (SpeedometerGauge) fragment_speedometer.findViewById(R.id.speedometer_target_id);
        speedometer_qos = (SpeedometerGauge) fragment_speedometer.findViewById(R.id.speedometer_qos_id);
        speedometer_SL = (SpeedometerGauge) fragment_speedometer.findViewById(R.id.speedometer_sl_id);

//41.32.29.164
        serverUrl = new StringBuilder("http://").append("41.32.29.164").append("/Android/Today_Target.php").toString();
        serverUrl2 = new StringBuilder("http://").append("41.32.29.164").append("/Android/Today_QOS.php").toString();
        serverUrl3 = new StringBuilder("http://").append("41.32.29.164").append("/Android/Today_ServiceLevel.php").toString();

        // speedometer _target
        Speedometer_Connection cone = new Speedometer_Connection(getActivity(), "today_Target");
        cone.execute(serverUrl);

        // speedometer_qos
        Speedometer_Connection cone2 = new Speedometer_Connection(getActivity(), "today_QOS");
        cone2.execute(serverUrl2);

        // Speedometer_service
        Speedometer_Connection cone3 = new Speedometer_Connection(getActivity(), "today_ServiceLevel");
