 ...
 */
public class Eva_Effort_Achieved_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View effort_achieved = inflater.inflate(R.layout.effort_achieved, container, false);
    ...
    class LoadAllData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                JSONArray json = jParser.makeHttpRequest("http://"+ SaveSharedPreference.getUserIP(getActivity())+AppConfig.url_time_evalution, "GET", params,"TIME_EVALUATION");
