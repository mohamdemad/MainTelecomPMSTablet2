 ...
 */
public class OutgoingQueuesCalls_BarChart extends Fragment {

    BarChart Outgoing_Queue_Calls_chart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View Outgoing_Queue_Calls = inflater.inflate(R.layout.outgoing_queues_calls_barchart, container, false);

        Outgoing_Queue_Calls_chart = (BarChart) Outgoing_Queue_Calls.findViewById(R.id.outgoing_queues_calls_chart);

        // Loading products in Background Thread
        new LoadAllData().execute();


        return Outgoing_Queue_Calls;
    }
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (search_check == 1) {
                    ...
                    JSONArray json1 = jParser.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Outgoing_Calls_Queue, "POST", params, "ROLES");

                    Log.d("Outgoing queue: ", json1.toString());
                    System.out.println("Outgoing queue: "+ json1.toString());
                    ...
                    JSONArray json_Queue = jParser_agents.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Queues_Data_List, "GET", params_Agents, "ROLES");
                    Log.d("Queue list: ", json_Queue.toString());
                    System.out.println("Queue list: "+ json_Queue.toString());
                    params.clear();
                    xAxis.clear();
                    ...
                    JSONArray json2 = jParser2.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Outgoing_Calls_Queue, "POST", params, "ROLES");
                    Log.d("Outgoing queue: ", json2.toString());
                    System.out.println("Outgoing queue: "+ json2.toString());
                    data_bar1.clear();
                    data_bar2.clear();
                    data_bar3.clear();
                    ...
                    for (int i = 1; i <= max2; i++) {
                        ...
                        Queue_name = c2.getString("Queue_Name");
                        //abandoned_calls = c.getString("abandoned_calls");
                        data_bar1.add(Float.parseFloat(completed_calls));
                        data_bar2.add(Float.parseFloat(cancelled_calls));
                        data_bar3.add(Float.parseFloat(Not_completed_calls));
...
//            l.setXEntrySpace(6f);
                ...
                Outgoing_Queue_Calls_chart.setData(data);
                Outgoing_Queue_Calls_chart.setDrawValueAboveBar(true);
                //Outgoing_Queue_Calls_chart.getXAxis().setTextColor(Color.WHITE);
                //Outgoing_Queue_Calls_chart.getLegend().setTextColor(Color.WHITE);
                Outgoing_Queue_Calls_chart.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM);
                Outgoing_Queue_Calls_chart.setDescription("");
                Outgoing_Queue_Calls_chart.animateXY(2000, 2000);
                Outgoing_Queue_Calls_chart.invalidate();
    ...
    public OutgoingQueuesCalls_BarChart (){}
    public static OutgoingQueuesCalls_BarChart newInstance(String[] ids,String[] names){
        ...
        outgoingQueuesCallsBarChart.setArguments(args);
