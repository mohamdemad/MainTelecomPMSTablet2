 ...
 */
public class HourlyOutgoingCallsQueue_BarChart extends Fragment {

    BarChart Hourly_Outgoing_Queue_Calls_chart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View Hourly_Outgoing_Queue_Calls = inflater.inflate(R.layout.hourly_outgoing_calls_queue_barchart, container, false);

        Hourly_Outgoing_Queue_Calls_chart = (BarChart) Hourly_Outgoing_Queue_Calls.findViewById(R.id.hourly_outgoing_calls_queue_chart);

        // Loading products in Background Thread
        new LoadAllData().execute();


        return Hourly_Outgoing_Queue_Calls;
    }
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (search_check == 1) {
                    ...
                    JSONArray json1 = jParser.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Hourly_Outgoing_Calls_Queue, "POST", params, "ROLES");
                    ...
                    System.out.println(json_agents.toString());
                    params.clear();
                    ...
                    JSONArray json2 = jParser.makeHttpRequest("http://" + SaveSharedPreference.getUserIP(getActivity()) + AppConfig.url_Hourly_Outgoing_Calls_Queue, "POST", params, "ROLES");
...
//            l.setXEntrySpace(6f);
                ...
                Hourly_Outgoing_Queue_Calls_chart.setData(data);
          //      Hourly_Outgoing_Queue_Calls_chart.getXAxis().setTextColor(Color.WHITE);
            //    Hourly_Outgoing_Queue_Calls_chart.getLegend().setTextColor(Color.WHITE);
                Hourly_Outgoing_Queue_Calls_chart.setDrawValueAboveBar(true);
                Hourly_Outgoing_Queue_Calls_chart.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM);
                Hourly_Outgoing_Queue_Calls_chart.setDescription("");
                Hourly_Outgoing_Queue_Calls_chart.animateXY(2000, 2000);
                Hourly_Outgoing_Queue_Calls_chart.invalidate();
    ...
    public HourlyOutgoingCallsQueue_BarChart (){}
    public static HourlyOutgoingCallsQueue_BarChart newInstance(String[] ids,String[] names){
        ...
        hourlyOutgoingCallsQueueBarChart.setArguments(args);
