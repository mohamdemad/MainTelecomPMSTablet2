...
public class PieChart_Leads extends Fragment implements OnRefreshListener {

	private RelativeLayout mainLayout;
	private PieChart chart;
	private float[] yData = new float[2];
	private String serverUrl,location;
	private String[] xData = { "Leads", "Outgoing Calls" };
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View fragment_pie_leads = inflater.inflate(R.layout.piechart_leads,
				container, false);
		...
		mainLayout = (RelativeLayout) fragment_pie_leads
				.findViewById(R.id.layout_piechart_leads);

		serverUrl = new StringBuilder("http://").append("41.32.29.164").append("/Android/Home_Charts/LeadsOutCalls.php").toString();

		Leads_Connection invoices_connection = new Leads_Connection(
				getContext(), "Leads", "Out_Calls");
		invoices_connection.execute(serverUrl);

		return fragment_pie_leads;
	...
	private void piechart() {
		...
		chart.setDescription("Leads/Outgoing Calls");
	...
	private void addData() {
		...
		System.out.println("flooooot : " + yarray.get(0));
		// create pie data set
	...
	private class Leads_Connection extends AsyncTask<String, Void, String> {

		Dialog dialog;
		Context context;
		String key_leads;
		String key_out_calls;
		//public AsyncReturn delegate = null;

		public Leads_Connection(Context context, String key_leads,
				String key_out_calls) {
			this.context = context;
			this.key_leads = key_leads;
			this.key_out_calls = key_out_calls;
		...
		public ArrayList<Float> returnParsedJsonObject(String result) {
			...
			try {
				...
				String leads_Result = resultObject.getString(key_leads);
				String outgoing_Result = resultObject.getString(key_out_calls);

				Result.add(Float.valueOf(leads_Result));
				Result.add(Float.valueOf(outgoing_Result));
	...
	public void onResume() {
		// TODO Auto-generated method stub
		System.out.println("resume leads");
		super.onResume();
	}
