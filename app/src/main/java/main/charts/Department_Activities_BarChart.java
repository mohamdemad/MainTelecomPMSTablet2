 ...
 */
public class Department_Activities_BarChart extends Fragment {
    ...
    View fragment_barchart_department_activities = inflater.inflate(R.layout.barchart_working_hours_layout, container, false);

    location = getArguments().getString("location");

    String url="http://"+ Login.enteredIP+"/Android/Team/Department_Activities.php";
